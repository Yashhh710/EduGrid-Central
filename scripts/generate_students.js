...
console.log('Generated 1000 students and 1000 gradebook rows');
console.log('GRADEBOOK_ROWS size:', JSON.stringify(gradebookRows).length, 'bytes');
console.log('STUDENTS size:', JSON.stringify(students).length, 'bytes');

// Export as module
module.exports = { gradebookRows, students };
